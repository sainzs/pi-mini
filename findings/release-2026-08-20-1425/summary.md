...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | typecheck | PASS | 0 | 2616 ms | `01-typecheck.log` |
| 2 | tests | PASS | 0 | 1273 ms | `02-tests.log` |
...
Evidence directory: `/Users/ssainz/Code/lab/pi-mini/findings/release-2026-08-20-1425`
