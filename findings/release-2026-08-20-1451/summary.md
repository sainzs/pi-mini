...
- Live mode: skipped
- Test files: tests/checkpoints.test.ts, tests/contract.test.ts, tests/gate.test.ts, tests/isolation.test.ts, tests/jspace.test.ts, tests/unit.test.ts
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | typecheck | PASS | 0 | 2834 ms | `01-typecheck.log` |
| 2 | tests | PASS | 0 | 1656 ms | `02-tests.log` |
...
Evidence directory: `/Users/ssainz/Code/lab/pi-mini/findings/release-2026-08-20-1451`
